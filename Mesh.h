...
class CUITexturedVertex : public CVertex
{
public:
	XMFLOAT2						m_xmf2TexCoord;
	float							m_fTexutreNumber;

public:
	CUITexturedVertex() { m_xmf3Position = XMFLOAT3(0.0f, 0.0f, 0.0f); m_xmf2TexCoord = XMFLOAT2(0.0f, 0.0f); m_fTexutreNumber = 0.0f; }
	CUITexturedVertex(float x, float y, float z, XMFLOAT2 xmf2TexCoord, float fTextureNumber = 0.0f) { m_xmf3Position = XMFLOAT3(x, y, z); m_xmf2TexCoord = xmf2TexCoord; m_fTexutreNumber = fTextureNumber; }
	CUITexturedVertex(XMFLOAT3 xmf3Position, XMFLOAT2 xmf2TexCoord, float fTextureNumber = 0.0f) { m_xmf3Position = xmf3Position; m_xmf2TexCoord = xmf2TexCoord; m_fTexutreNumber = fTextureNumber; }
	~CUITexturedVertex() { }
};
...
{
public :
	CUIMeshTextured(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, XMFLOAT3& xmf3StartPos, XMFLOAT3& xmf3EndPos, float fTexutreNum, float fsize = 1.0f);
